      ...
      <section className="px-6 py-20 bg-gradient-to-br from-gray-50 to-white dark:from-gray-800 dark:to-gray-900">
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto dark:text-gray-300">
              Monitor all your hydroponic system metrics in real-time with our intuitive dashboard
            </p>
          </motion.div>

          <div className="relative">
            <InteractiveCard className="bg-white dark:bg-gray-800 rounded-3xl shadow-2xl p-8 overflow-hidden">
              {/* Dashboard header */}
              ...
              <div className="bg-gradient-to-r from-primary-500/10 to-blue-500/10 p-6 rounded-2xl mb-6">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                  <div className="bg-white dark:bg-gray-700 p-4 rounded-xl shadow">
                    <div className="flex items-center">
                      <Droplets className="w-8 h-8 text-blue-500 mr-3" />
                      <div>
                        <div className="text-2xl font-bold text-gray-900 dark:text-white">6.8</div>
                  ...
                  <div className="bg-white dark:bg-gray-700 p-4 rounded-xl shadow">
                    <div className="flex items-center">
                      ...
                      <div>
                        <div className="text-2xl font-bold text-gray-900 dark:text-white">24.5°C</div>
                  ...
                  <div className="bg-white dark:bg-gray-700 p-4 rounded-xl shadow">
                    <div className="flex items-center">
                      ...
                      <div>
                        <div className="text-2xl font-bold text-gray-900 dark:text-white">560</div>
