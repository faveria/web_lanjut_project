...
- **MQTT Broker**: 148.230.97.142:1883
...
- **Hosting Platform**: Self-hosted on dedicated VPS (IP: 148.230.97.142)
...
- **Environment Variables** (stored in `.env`):
  ...
  - `MQTT_BROKER_URL`: MQTT broker address (`mqtt://148.230.97.142:1883`)
